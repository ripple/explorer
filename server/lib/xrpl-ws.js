...
const RIPPLEDS = [
  {
    host: import.meta.env.REACT_APP_RIPPLED_HOST,
    port: import.meta.env.REACT_APP_RIPPLED_WS_PORT,
    primary: true,
  },
]
...
if (import.meta.env.REACT_APP_RIPPLED_SECONDARY) {
  import.meta.env.REACT_APP_RIPPLED_SECONDARY.split(',').forEach((d) => {
