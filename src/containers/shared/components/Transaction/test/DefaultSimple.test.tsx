...
describe('DefaultSimple', () => {
  ...
  it('renders Simple for more complex transaction', () => {
    ...
    expect(screen.find(`[data-testid="group"]`).length).toEqual(10)
    expect(screen.find(`[data-testid="CreateCode"]`).length).toEqual(10)
    expect(screen.find(`[data-testid="Flags"]`).length).toEqual(10)
    expect(screen.find(`[data-testid="HookApiVersion"]`).length).toEqual(2)
    expect(screen.find(`[data-testid="HookNamespace"]`).length).toEqual(2)
    expect(screen.find(`[data-testid="HookOn"]`).length).toEqual(2)
    ...
    expect(screen.find(`[data-testid="Flags"] .value`).at(0)).toHaveText('1')
    expect(
      screen.find(`[data-testid="HookApiVersion"] .value`).at(0),
    ).toHaveText('0')
    expect(
      screen.find(`[data-testid="HookNamespace"] .value`).at(0),
    ).toHaveText(
  ...
  it('renders Simple for more complex transaction', () => {
    ...
    expect(screen.find(`[data-testid="group"]`).length).toEqual(1)
    expect(screen.find(`[data-testid="CreateCode"]`).length).toEqual(1)
    expect(screen.find(`[data-testid="Flags"]`).length).toEqual(1)
    expect(screen.find(`[data-testid="HookApiVersion"]`).length).toEqual(1)
    expect(screen.find(`[data-testid="HookNamespace"]`).length).toEqual(1)
    expect(screen.find(`[data-testid="HookOn"]`).length).toEqual(1)
    expect(screen.find(`[data-testid="HookParameters"]`).length).toEqual(1)
  ...
  it('renders Simple for amount', () => {
    ...
    expect(screen.find(`[data-testid="AccountOther"] a`)).toExist()
    expectSimpleRowText(
      screen,
      'Amount',
