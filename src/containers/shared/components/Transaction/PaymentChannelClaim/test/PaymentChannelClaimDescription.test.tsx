...
describe('PaymentChannelClaim: Description', () => {
  it('renders a claim', () => {
    ...
    expect(container.querySelector('[data-testid="account-line"]')).toHaveTextContent(
    ...
    expect(container.querySelector('[data-testid="balance-line"]')).toHaveTextContent(
      `The channel balance claimed is \uE90049.65716XRP (increased by \uE9000.01XRP)`,
    )
    expect(container.querySelector('[data-testid="closed-line"]')).not.toBeInTheDocument()
    unmount()
  })
  ...
  it('renders tx with channel being closed', () => {
    ...
    expect(container.querySelector('[data-testid="balance-line"]')).not.toBeInTheDocument()
    expect(container.querySelector('[data-testid="closed-line"]')).toHaveTextContent(
