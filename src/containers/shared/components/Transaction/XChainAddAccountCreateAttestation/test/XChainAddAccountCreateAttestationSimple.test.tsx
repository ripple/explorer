...
describe('XChainAddAccountCreateAttestationSimple', () => {
  it('renders', () => {
    const { container, unmount } = renderComponent(mockXChainAddAccountCreateAttestation)
  ...
  it('renders failed transaction', () => {
    const { container, unmount } = renderComponent(mockXChainAddAccountCreateAttestationFailed)
