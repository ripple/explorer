...
describe('NFTokenCreateOffer', () => {
  it('handles NFTokenCreateOffer buy simple view ', () => {
    ...
    expectSimpleRowText(container, 'owner', 'r9AExd6v3keXaXa3nXAMHHcP9nWy9Aef2g')
    expectSimpleRowText(container, 'amount', '\uE9000.0001 XRP')
    expect(container.querySelector('[data-testid="buyer-or-seller"] .label')).toHaveTextContent(
      'buyer',
    )
    expectSimpleRowText(
      container,
    ...
    expect(container.querySelector('[data-testid="destination"] .value')).not.toBeInTheDocument()
    unmount()
  })
  ...
  it('handles NFTokenCreateOffer sell simple view ', () => {
    ...
    expect(container.querySelector('[data-testid="owner"] .value')).not.toBeInTheDocument()
    expectSimpleRowText(
      container,
      'amount',
