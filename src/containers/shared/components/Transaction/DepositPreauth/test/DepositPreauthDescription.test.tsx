...
describe('DepositPreauth: Description', () => {
  it('renders description for authorize', () => {
    ...
    expect(wrapper.html()).toBe(
      `<div>It authorizes <a title="rDJFnv5sEfp42LMFiX3mVQKczpFTdxYDzM" class="account" href="/accounts/rDJFnv5sEfp42LMFiX3mVQKczpFTdxYDzM">rDJFnv5sEfp42LMFiX3mVQKczpFTdxYDzM</a> to send payments to this account</div>`,
    )
    wrapper.unmount()
  })
  ...
  it('renders description for unauthorize', () => {
    ...
    expect(wrapper.html()).toBe(
      `<div>It removes the authorization for <a title="rDJFnv5sEfp42LMFiX3mVQKczpFTdxYDzM" class="account" href="/accounts/rDJFnv5sEfp42LMFiX3mVQKczpFTdxYDzM">rDJFnv5sEfp42LMFiX3mVQKczpFTdxYDzM</a> to send payments to this account</div>`,
    )
    wrapper.unmount()
  })
})
