...
describe('Payment: Description', () => {
  it('renders', () => {
    ...
    expect(container.querySelector('[data-testid="source-tag-line"]')).not.toBeInTheDocument()
    expect(container.querySelector('[data-testid="destination-tag-line"]')).not.toBeInTheDocument()
    expect(container.querySelector('[data-testid="amount-line"]')).toHaveTextContent(
      `It was instructed to deliver \uE9002,421.8268 XRP`,
    )
    expect(container.querySelector('[data-testid="delivered-line"]')).toHaveTextContent(
  ...
  it('renders with failed partial conversion', () => {
    ...
    expect(container.querySelector('[data-testid="delivered-line"]')).not.toBeInTheDocument()
  ...
  it('renders with destination tag', () => {
    ...
    expect(container.querySelector('[data-testid="source-tag-line"]')).not.toBeInTheDocument()
    expect(container.querySelector('[data-testid="destination-tag-line"]')).toHaveTextContent(
  ...
  it('renders with SourceTag', () => {
    ...
    expect(container.querySelector('[data-testid="source-tag-line"]')).toHaveTextContent(
  ...
  it(`renders with Permissioned Domain ID`, () => {
    ...
    expect(container.querySelector('[data-testid="domain-id-line"]')).toHaveTextContent(
