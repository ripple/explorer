...
describe('EscrowFinishSimple', () => {
  it('renders with an expiration and offer', () => {
    ...
    expect(wrapper.find('[data-test="escrow-destination"] .value')).toHaveText(
      `r4UDXF4nL7Tgss8uQxn39cCocd8GnGyXS8`,
    )
    expect(wrapper.find('[data-test="escrow-tx"] .value')).toHaveText(
      `3E2E755FA75FF1020C39E2ECC407E9F1C0E49A7229EDD15FF93B9F869878F1CC`,
    )
    expect(wrapper.find('[data-test="escrow-fullfillment"] .value')).toHaveText(
      `Fulfillment`,
    )
    wrapper.unmount()
  })
