...
describe('EscrowCreateDescription', () => {
  it('renders description for EscrowCreate', () => {
    const { container, unmount } = renderComponent(getTestByName('renders EscrowCreate'))
  ...
  it('test IOU amount', () => {
    const { container, unmount } = renderComponent(getTestByName('test IOU amount'))
    expect(container.querySelector('[data-testid="amount-line"]')).toHaveTextContent(
  ...
  it('test MPT amount', () => {
    ...
    const { container, unmount } = renderComponent(getTestByName('test MPT amount'))
    expect(container.querySelector('[data-testid="amount-line"]')).toHaveTextContent(
