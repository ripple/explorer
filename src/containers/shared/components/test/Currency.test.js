...
describe('Currency', () => {
  it('handles currency codes that are 3 characters ', () => {
    const wrapper = mount(
      <Currency currency={"BTC"} amount={5.001} />
    );
  ...
  it('handles currency codes that are 4 characters ', () => {
    const wrapper = mount(
      <Currency currency={"WOOT"} amount={5.001} />
    );
  ...
  it('handles currency codes that are 40 characters and issuer ', () => {
    const wrapper = mount(
      <BrowserRouter>
        <Currency currency="584D455441000000000000000000000000000000" issuer="r3XwJ1hr1PtbRvbhuUkybV6tmYzzA11WcB" amount={5.001} />
      </BrowserRouter>
    );
