...
describe('Amount', () => {
  it('handles currency codes that are 3 characters ', () => {
    ...
    const wrapper = mount(<BrowserRouter><Amount value={value} /></BrowserRouter>);
  ...
  it('handles currency codes with standard symbols', () => {
    ...
    const wrapper2 = mount(<BrowserRouter><Amount value={value2} /></BrowserRouter>);
  ...
  it('handles currency codes that are 40 characters ', () => {
    ...
    const wrapper = mount(
      <BrowserRouter><Amount value={value} /></BrowserRouter>
    );
    expect(wrapper.find('.currency').text()).toEqual('XAUÁ÷oöì°ºÆ.rrh7rf1gV2pXAoqA8oYbpHd8TKv5ZQeo67');
