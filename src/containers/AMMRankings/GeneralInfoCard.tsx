...
export const GeneralInfoCard: FC<GeneralInfoCardProps> = ({
  ...
  const volume24h = currencyMode === 'usd' ? stats.trading_volume_usd : stats.trading_volume_xrp
  ...
  const formatCurrencyAmount = (value: number): string => {
    ...
    if (value >= 1000000000) {
      const formatted = currencyMode === 'usd'
  ...
  return (
    <div className="general-info-card">
      ...
      <div className="stats-container">
        ...
        <div className="stat-row">
          <div className="stat-label">{t('number_of_lps')}</div>
          <div className="stat-value">
        ...
        <div className="stat-row">
          ...
          <div className="stat-value">
            {volume24h
              ? formatCurrencyAmount(volume24h)
              : DEFAULT_EMPTY_VALUE}
          </div>
        </div>
      </div>
