...
import { ReactComponent as SuccessIcon } from 'containers/shared/images/success.svg'
import { ReactComponent as FailIcon } from 'containers/shared/images/ic_fail.svg'
import { localizeDate, concatTx } from 'containers/shared/utils'
import { loadAccountTransactions } from 'containers/Accounts/AccountTransactionsTable/actions'
import Loader from 'containers/shared/components/Loader'
import TxDetails from 'containers/shared/components/TxDetails'
import 'containers/Accounts/AccountTransactionsTable/styles.scss'
import TxLabel from 'containers/shared/components/TxLabel'
import SocketContext from 'containers/shared/SocketContext'
import { LoadMoreButton } from 'containers/shared/LoadMoreButton'
import TxToken from 'containers/shared/components/TxToken'
...
export const AMMAccountTxTable = (props) => {
    ...
    <div className="section transactions-table">
      <ol className="account-transactions">
        <li className="transaction-li transaction-li-header">
          <div className="col-token">{t('tokens')}</div>
...
AMMAccountTxTable.defaultProps = {
  loadingError: '',
}
