...
describe('DetailTab container', () => {
    ...
    mount(
      <Router>
        <I18nextProvider i18n={i18n}>
          <DetailTab t={s => s} language="en-US" data={Transaction} width={width} />
        </I18nextProvider>
      </Router>
    );
  ...
  it('renders all parts', () => {
    ...
    expect(wrapper.contains(<div className="title">description</div>)).toBe(true);
    expect(
      wrapper.contains(
        <div className="title">
          memos
    ...
    expect(wrapper.contains(<div className="title transaction-cost">transaction_cost</div>)).toBe(
      true
    );
