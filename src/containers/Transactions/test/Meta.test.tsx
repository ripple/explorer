...
describe('TransactionMeta container', () => {
  ...
  it('renders Meta', () => {
    ...
    expect(w.find('li').at(6).html()).toBe(
      '<li class="meta-line">transaction_owned_directory<span> <a data-testid="account" class="account" title="rETx8GBiH6fxhTcfHM9fGeyShqxozyD3xe" href="/accounts/rETx8GBiH6fxhTcfHM9fGeyShqxozyD3xe">rETx8GBiH6fxhTcfHM9fGeyShqxozyD3xe</a></span></li>',
    )

    expect(w.find('li').at(7).html()).toBe(
      '<li class="meta-line">It modified a <b>XRP/CNY</b>owned by<a data-testid="account" class="account" title="rEGoBvzusE2MkDn3yrgZc817XiwRofqoJq" href="/accounts/rEGoBvzusE2MkDn3yrgZc817XiwRofqoJq">rEGoBvzusE2MkDn3yrgZc817XiwRofqoJq</a>with sequence # <b>1181517</b><ul><li class="meta-line">offer_partially_filled</li><li class="meta-line"><span class="field">TakerPays </span><b>XRP</b> decreased by<b>\uE90050.324316</b>from<b>\uE900470.31823</b>to<b>\uE900419.993914</b></li><li class="meta-line"><span class="field">TakerGets </span><b>CNY</b>.<a data-testid="account" class="account" title="rKiCet8SdvWxPXnAgYarFUXMh1zCPz432Y" href="/accounts/rKiCet8SdvWxPXnAgYarFUXMh1zCPz432Y">rKiCet8SdvWxPXnAgYarFUXMh1zCPz432Y</a> decreased by<b>CN¥224.7141103</b>from<b>CN¥2,100.12079671</b>to<b>CN¥1,875.40668641</b></li></ul></li>',
    )
    ...
    expect(w.find('li').at(10).html()).toBe(
      '<li class="meta-line"><span class="field">TakerGets </span><b>CNY</b>.<a data-testid="account" class="account" title="rKiCet8SdvWxPXnAgYarFUXMh1zCPz432Y" href="/accounts/rKiCet8SdvWxPXnAgYarFUXMh1zCPz432Y">rKiCet8SdvWxPXnAgYarFUXMh1zCPz432Y</a> decreased by<b>CN¥224.7141103</b>from<b>CN¥2,100.12079671</b>to<b>CN¥1,875.40668641</b></li>',
    )

    expect(w.find('li').at(11).html()).toBe(
      '<li class="meta-line">It modified a <b>XRP/CNY</b>owned by<a data-testid="account" class="account" title="rUmustd4TbkjaEuS7S1damozpBEREgRz9z" href="/accounts/rUmustd4TbkjaEuS7S1damozpBEREgRz9z">rUmustd4TbkjaEuS7S1damozpBEREgRz9z</a>with sequence # <b>5804</b><ul><li class="meta-line">offer_partially_filled</li><li class="meta-line"><span class="field">TakerPays </span><b>CNY</b>.<a data-testid="account" class="account" title="razqQKzJRdB4UxFPWf5NEpEG3WMkmwgcXA" href="/accounts/razqQKzJRdB4UxFPWf5NEpEG3WMkmwgcXA">razqQKzJRdB4UxFPWf5NEpEG3WMkmwgcXA</a> decreased by<b>CN¥225.45293634</b>from<b>CN¥12,589.58241408</b>to<b>CN¥12,364.12947774</b></li><li class="meta-line"><span class="field">TakerGets </span><b>XRP</b> decreased by<b>\uE90050.324316</b>from<b>\uE9002,810.174646</b>to<b>\uE9002,759.85033</b></li></ul></li>',
    )
    ...
    expect(w.find('li').at(13).html()).toBe(
      '<li class="meta-line"><span class="field">TakerPays </span><b>CNY</b>.<a data-testid="account" class="account" title="razqQKzJRdB4UxFPWf5NEpEG3WMkmwgcXA" href="/accounts/razqQKzJRdB4UxFPWf5NEpEG3WMkmwgcXA">razqQKzJRdB4UxFPWf5NEpEG3WMkmwgcXA</a> decreased by<b>CN¥225.45293634</b>from<b>CN¥12,589.58241408</b>to<b>CN¥12,364.12947774</b></li>',
    )
    ...
    expect(w.find('li').at(15).html()).toBe(
      '<li class="meta-line">It modified a <b>CNY</b>ripplestate node between<a data-testid="account" class="account" title="rUmustd4TbkjaEuS7S1damozpBEREgRz9z" href="/accounts/rUmustd4TbkjaEuS7S1damozpBEREgRz9z">rUmustd4TbkjaEuS7S1damozpBEREgRz9z</a>and<a data-testid="account" class="account" title="razqQKzJRdB4UxFPWf5NEpEG3WMkmwgcXA" href="/accounts/razqQKzJRdB4UxFPWf5NEpEG3WMkmwgcXA">razqQKzJRdB4UxFPWf5NEpEG3WMkmwgcXA</a><ul class="meta-line"><li>Balance changed by<b>CN¥225.45293634</b>from<b>CN¥187,682.19557797</b>to<b>CN¥187,907.64851431</b></li></ul></li>',
    )
    ...
    expect(w.find('li').at(17).html()).toBe(
      '<li class="meta-line">It modified a <b>CNY</b>ripplestate node between<a data-testid="account" class="account" title="rPt8rwFrsucmjdKfjwRHGz9iZGxxN2cLYh" href="/accounts/rPt8rwFrsucmjdKfjwRHGz9iZGxxN2cLYh">rPt8rwFrsucmjdKfjwRHGz9iZGxxN2cLYh</a>and<a data-testid="account" class="account" title="rKiCet8SdvWxPXnAgYarFUXMh1zCPz432Y" href="/accounts/rKiCet8SdvWxPXnAgYarFUXMh1zCPz432Y">rKiCet8SdvWxPXnAgYarFUXMh1zCPz432Y</a><ul class="meta-line"><li>Balance changed by<b>CN¥224.7141103</b>from<b>CN¥68,093.01974027</b>to<b>CN¥68,317.73385057</b></li></ul></li>',
    )
    ...
    expect(w.find('li').at(19).html()).toBe(
      '<li class="meta-line">It modified a <b>CNY</b>ripplestate node between<a data-testid="account" class="account" title="rEGoBvzusE2MkDn3yrgZc817XiwRofqoJq" href="/accounts/rEGoBvzusE2MkDn3yrgZc817XiwRofqoJq">rEGoBvzusE2MkDn3yrgZc817XiwRofqoJq</a>and<a data-testid="account" class="account" title="rKiCet8SdvWxPXnAgYarFUXMh1zCPz432Y" href="/accounts/rKiCet8SdvWxPXnAgYarFUXMh1zCPz432Y">rKiCet8SdvWxPXnAgYarFUXMh1zCPz432Y</a><ul class="meta-line"><li>Balance changed by<b>-CN¥224.7141103</b>from<b>CN¥9,605.02284129</b>to<b>CN¥9,380.30873099</b></li></ul></li>',
    )
    ...
    expect(w.find('li').at(21).html()).toBe(
      '<li class="meta-line">It modified a <b>CNY</b>ripplestate node between<a data-testid="account" class="account" title="razqQKzJRdB4UxFPWf5NEpEG3WMkmwgcXA" href="/accounts/razqQKzJRdB4UxFPWf5NEpEG3WMkmwgcXA">razqQKzJRdB4UxFPWf5NEpEG3WMkmwgcXA</a>and<a data-testid="account" class="account" title="rPt8rwFrsucmjdKfjwRHGz9iZGxxN2cLYh" href="/accounts/rPt8rwFrsucmjdKfjwRHGz9iZGxxN2cLYh">rPt8rwFrsucmjdKfjwRHGz9iZGxxN2cLYh</a><ul class="meta-line"><li>Balance changed by<b>CN¥225.90384221</b>from<b>-CN¥225.90384221</b>to<b>CN¥0.00</b></li></ul></li>',
    )
