...
describe('NFTokenAcceptOffer', () => {
  it('handles NFTokenAcceptOffer Buy simple view ', () => {
    ...
    expect(wrapper.find('[data-test="buyer"]')).toHaveText(
      'rfFRmXUR1yfxeUfXj7WwKhETrtToYx1hYh',
    )
    expect(wrapper.find('[data-test="seller"]')).toHaveText(
  ...
  it('handles NFTokenAcceptOffer Sell simple view ', () => {
    ...
    expect(wrapper.find('[data-test="amount"]')).toHaveText('0.000102 XRP')
    expect(wrapper.find('[data-test="buyer"]')).toHaveText(
      'rfFRmXUR1yfxeUfXj7WwKhETrtToYx1hYh',
    )
    expect(wrapper.find('[data-test="seller"]')).toHaveText(
